...
![Central Limit Theorem demonstration](./figures/clt_demo.png)
...
![Maximum Likelihood Estimation](./figures/mle_gaussian.png)
...
![MAP shrinks the MLE estimate toward the prior](./figures/map_vs_mle.png)
