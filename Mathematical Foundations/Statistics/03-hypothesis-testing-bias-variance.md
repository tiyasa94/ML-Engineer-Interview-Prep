...
![p-value visualization](./figures/pvalue.png)
...
![Bootstrap confidence interval](./figures/bootstrap_ci.png)
...
![Bias-variance tradeoff curve](./figures/bias_variance_curve.png)
