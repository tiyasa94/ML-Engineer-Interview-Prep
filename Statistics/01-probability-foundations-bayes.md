...
**Book reference:** *Mathematics for Machine Learning* (Deisenroth, Faisal, Ong) (https://drive.google.com/file/d/1LGisFRLBa8YojQ7EOd4rPUWeicjsN8ys/view) - §6.1–6.4, pp.172–186 (Construction of a Probability Space, Discrete and Continuous Probabilities, Sum Rule/Product Rule/Bayes' Theorem, Summary Statistics and Independence)
...
![Bayes' theorem worked example, disease testing](./figures/bayes_partition.png)
...
![Independence vs. correlation](./figures/independence_vs_correlation.png)
